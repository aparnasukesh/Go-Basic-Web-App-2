...
import (
	"aparnasukesh/github.com/Go-Basic-WebApp2/middleware"
	"aparnasukesh/github.com/Go-Basic-WebApp2/model"
	"html/template"
	"net/http"
	"strconv"
...
func Routes(r *gin.Engine) {
	...
	store := cookie.NewStore([]byte("abc"))
	r.Use(sessions.Sessions("session", store))

	r.GET("/login", middleware.Middleware, loginPage)
	r.GET("/signup", middleware.Middleware, signUpPage)
	r.GET("/home", middleware.AuthRequired(), homePage)
